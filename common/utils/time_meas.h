...
#ifndef __TIME_MEAS__H__
#define __TIME_MEAS__H__
...
#include "common/utils/time_meas_defs.h"
...
/**
 * TIME_MEAS_HISTOGRAM_BIN_WIDTH_NS,
 * TIME_MEAS_HISTOGRAM_SPAN_NS and
 * TIME_MEAS_HISTOGRAM_NUM_BINS
 * are defined in time_meas_defs.h
 * which is generated by cmake from
 * time_meas_defs.h.in with default
 * values from the CMakeLists.txt
 */
typedef struct {

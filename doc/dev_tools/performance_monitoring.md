...
* A tracers such as [Tracy](#performance-analysis-with-the-tracy-profiler) enables an inclusive and in depth monitoring of the performance of a specified part of software.

## Benchmarking purpose

* The [time stats tool](#processing-times-statistics-with-the-time-stats) is an embedded processing time recorder for macroscopic computing blocks.
...
**It is not** intended for debugging. For performance debugging tools, refer to the [debugging tools section](#debugging-purpose).

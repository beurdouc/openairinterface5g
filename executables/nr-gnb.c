...
static void load_l1tx_rt_deadline_config_once(void)
{
  ...
  printf("RT_DEADLINE_CONFIG_L1TX enabled=%d report_period=%lu late_threshold_us=%lu "
         ...
         "capture_enable=%d capture_async_flush_enable=%d capture_final_dump_enable=%d capture_samples=%lu capture_path=%s\n",
...
static void load_l1rx_rt_deadline_config_once(void)
{
  ...
  printf("RT_DEADLINE_CONFIG_L1RX enabled=%d report_period=%lu "
         ...
         "capture_enable=%d capture_async_flush_enable=%d "

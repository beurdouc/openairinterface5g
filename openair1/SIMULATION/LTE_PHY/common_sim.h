...
static inline double median(time_stats_t *ptr)
{
  return time_stats_value_us(ptr, get_median);
}

static inline double q1(time_stats_t *ptr)
{
  return time_stats_value_us(ptr, get_q1);
}

static inline double q3(time_stats_t *ptr)
{
  return time_stats_value_us(ptr, get_q3);
}

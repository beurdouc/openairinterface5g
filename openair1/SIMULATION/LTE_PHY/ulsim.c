...
int main(int argc, char **argv) {
  ...
  */
  ...
  init_time_stats_histogram(&UE->phy_proc_tx.time_stats_histogram);
  init_time_stats_histogram(&UE->ofdm_mod_stats.time_stats_histogram);
  init_time_stats_histogram(&UE->ulsch_modulation_stats.time_stats_histogram);
  init_time_stats_histogram(&UE->ulsch_encoding_stats.time_stats_histogram);
  init_time_stats_histogram(&eNB->phy_proc_rx.time_stats_histogram);
  init_time_stats_histogram(&ru->ofdm_demod_stats.time_stats_histogram);
  init_time_stats_histogram(&eNB->ulsch_demodulation_stats.time_stats_histogram);
  init_time_stats_histogram(&eNB->ulsch_decoding_stats.time_stats_histogram);
  ...
  free_time_stats_histogram(&UE->phy_proc_tx.time_stats_histogram);
  free_time_stats_histogram(&UE->ofdm_mod_stats.time_stats_histogram);
  free_time_stats_histogram(&UE->ulsch_modulation_stats.time_stats_histogram);
  free_time_stats_histogram(&UE->ulsch_encoding_stats.time_stats_histogram);
  free_time_stats_histogram(&eNB->phy_proc_rx.time_stats_histogram);
  free_time_stats_histogram(&ru->ofdm_demod_stats.time_stats_histogram);
  free_time_stats_histogram(&eNB->ulsch_demodulation_stats.time_stats_histogram);
  free_time_stats_histogram(&eNB->ulsch_decoding_stats.time_stats_histogram);
